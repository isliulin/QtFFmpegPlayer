...
DrawI420::DrawI420(const char* url, int width, int height)
...
void DrawI420::InitializeCanvas()
{
...
void DrawI420::initializeGL()
{
	...
	program.addShaderFromSourceCode(QGLShader::Fragment, I420_fragment);
...
void DrawI420::resizeGL(int w, int h)
{
